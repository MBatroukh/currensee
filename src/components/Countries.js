...
class Countries extends React.Component {
    ...
    render() {
        ...
        //     this.setState({ [event.target.name]: event.target.value }, onChange);
        // };

        return (
            <FormControl>
                <InputLabel htmlFor="country-name">Country</InputLabel>
                <Select
                ...
                >
                    ...
                    <MenuItem value="Palau">Palestine</MenuItem>
                    ...
                    <MenuItem value="Yugoslavia">Yugoslavia</MenuItem>
